...
- Google Calendar Sync: Outbound mirror sync v1 is implemented, but live Google API verification remains pending.
- Deferred: Google Calendar sync browser verification, delete/conflict hardening, recurrence rule mutation support, and full visual drag-and-drop slots editing.
